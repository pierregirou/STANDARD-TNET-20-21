...
if(isset($_POST) && !empty($_POST)){
    ...
    while($donnees=$reponse->fetch()){
        ...
        $libPictoArray[]="../Photos/Coloris/-".$donnees["codeColori"]."-".$donnees["libcolori"]."-1.jpg";
    }
        ...
        while($donnees2=$reponse2->fetch()){
            ...
            while($donnees3=$reponse3->fetch()){
              ...
              WHERE codetarif=:codeTarif AND refproduit=:refproduit AND codeColori=:codeColori AND stockdisponible > 0 AND nonCommandable > 0");
                ...
                $arrdetail[4][$k][$j]["codeTheme"]=$donnees4["codeTheme"];
                $arrdetail[4][$k][$j]["texteLibre"]=$donnees4["texteLibre"];
