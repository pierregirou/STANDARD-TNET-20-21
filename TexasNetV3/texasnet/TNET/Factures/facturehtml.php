...
<table>
		<tr>
			<td colspan="3"><img src="../Images/logo-net.png" width="450" height="60" /></td>			
			<td colspan="1"></td>
		</tr>
		...
		<tr>
			<td><span class="textentete">Client : <?php echo $profil['codeClient'].' '.$profil['raisonSociale'];?> </span></td>
	...
	<table>
		<tr>
			<td>
				<table class="sample" style="font-size:16px;">
					<tr>
						<td class="titreAdresse">R&eacute;glement / Payment</td>
					</tr>
					<tr>
			...
			<td>
				<table class="sample" style="font-size:16px">
					<tr>
						<td class="titreAdresse">Renseignements facturation</td>
					</tr>
					<tr>
						<td class="textAdresse">
