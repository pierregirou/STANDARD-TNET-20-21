...
<table>
		...
		<tr>
			<td><span class="textentete">Customer code : <?php echo $profil['codeClient'].' '.$profil['raisonSociale'];?> </span></td>
	...
	<table>
		<tr>
			<td>
				<table class="sample" style="font-size:16px;">
					<tr>
						<td class="titreAdresse">Payment</td>
					</tr>
					<tr>
			...
			<td>
				<table class="sample" style="font-size:16px">
					<tr>
						<td class="titreAdresse">Billing Information</td>
					</tr>
					<tr>
						<td class="textAdresse">
