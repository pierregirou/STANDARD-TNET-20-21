<?php
include("/home/amateispro/public_html/export/connect.php");
...
if($nbrCmd>0){
	...
	$fp = fopen("/home/amateispro/public_html/export/commandes/".$nom,"a"); // ouverture du fichier en ecriture
	...
	$file = "/home/amateispro/public_html/export/commandes/$nom";
	$newfile = "/home/amateispro/public_html/export/commandes/sauvegardes/$nom";
