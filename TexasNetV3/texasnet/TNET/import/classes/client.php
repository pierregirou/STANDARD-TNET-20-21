<?php
	class Client
	{
		...
		public function upInfos($codeClient,$password,$fiscal){
			// $req="update client set  password='$password', codeFiscal=$fiscal where login ='$codeClient'";
			$req="update client set codeFiscal=$fiscal where login ='$codeClient'";
			echo $req;
			$ex=mysql_query($req);
			return $ex;
		}
		...
		public function addAdresse($login,$adresse,$cp,$ville,$pays,$num,$type){
