...
if(isset($_POST) && !empty($_POST)){
			...
			substring(ma.libelle,locate('".$_POST['langue']."',ma.libelle)+3,locate('/',substring(ma.libelle,locate('".$_POST['langue']."',ma.libelle)+3))-1) as codeMatiere,

			 `nonCommandable`, `poids`, `codetarif`, `prix`, `libcolori`, `libMarque`, `commentaire1`, `commentaire2`, `commentaire3`, `commentaire4`, `commentaire5`, `selection`, `promo`, `tarif_promo`, `positionGalerie`, `tarif_pvc`, `stockdisponible`, `libelle2`, pg.position1, pg.position2, pg.position3, pg.position4, pg.position5, pg.position6, pgp.position1, pgp.position2, pgp.position3, pgp.position4, pgp.position5, pgp.position6, CONCAT(substring(ma.libelle,locate('".$_POST['langue']."',ma.libelle)+3,locate('/',substring(ma.libelle,locate('".$_POST['langue']."',ma.libelle)+3))-1),' ', substring(t.libelle,locate('".$_POST['langue']."',t.libelle)+3,locate('/',substring(t.libelle,locate('".$_POST['langue']."',t.libelle)+3))-1)) as texteLibre
			 FROM produit p
			 ...
			 LEFT JOIN matiere ma ON p.codeMatiere = ma.idMatiere 
