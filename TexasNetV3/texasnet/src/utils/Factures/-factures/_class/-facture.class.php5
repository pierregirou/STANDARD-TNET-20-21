...
class docHTMLPDF{
	...
	public function getProduit($numcmd){
		...
		<tr>
			<th width="80" height="20%">Produit fini / Coloris  <br /></th>
			<th width="200">D&eacute;signation / Description</th>
		...
		while($donnees = $reponse->fetch()){	
			...
			echo "<tr>";
				echo "<td>".$infoProd['refproduit']."</td>";
				echo "<td>".$infoProd['libelle']."</td>";
				echo "<td>".$infoProd['codeMarque']."</td>";
			echo "</tr>";
			echo "<tr>";
				echo "<td>";
