<?php
	...
	class Produit 
	{
		...
		public function addProduit($ref,$libelle,$codecolori,$codegamme,$tailledeb,$taillefin,$saison,$marque,$theme,$famille,$sousfamille,$modele,$codeligne,$nomcmd,$description,$poids,$champsstat,$codetarif,$stockdisponible,$stockencmd,$stockaterme,$prix,$libcolori,$libmarque,$com1,$com2,$com3,$com4,$com5){	
			$com .= $com2;
			$com .= $com3;
			$com .= $com4;
			$com .= $com5;
			//echo $com;
			$req="insert into produit values('','$ref','$libelle','$codecolori','$codegamme','$tailledeb','$taillefin','$saison','$marque','$theme','$famille','$sousfamille','$modele','$codeligne','$nomcmd','$poids','$codetarif','$prix','$libcolori','$libmarque','$com1','$com','','','','0','0','0','0','0','0')" ;
			echo $req."<br>";
			// echo "<br>";
			$exec=mysql_query($req);
		}
